                ...
                <div class="w-100" id="cutomerRegistration">
                    ...
                    <div class="mb-3 ">
                        <div class="col-12 col-md-6 px-1">
                            <div class=" mb-2 ">
                                <input type="text" name="lastname"  id="myInput" readonly onclick="copyToClipboard(this)"
                                 class="form-control clipboard-btn "  value="{customerSelfReg portal link}"  />
            
                            </div>
                            <p id="successMessage" class="mt-1">click to copy</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('user.customer') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex p-2 flex-column">
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-6 col-12 px-1">
                                    <select class="form-select" aria-label="Default select example" name="package_name" value="{{ old('package_name') }}" required>
    ...
    function copyToClipboard(element) {
      ...
      if (navigator.clipboard) {
        navigator.clipboard.writeText(element.value)
          .then(() => {
            successMessage.innerText = 'Link successfully copied to clipboard';
