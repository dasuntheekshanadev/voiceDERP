...
<body>
    ...
    <div class="heading-div">
        <table style="width:100%;">
            <tr>
                <td style="width:70px;">
                    <img src="<?php echo e(asset($details->logo)); ?>" alt="logo" style="width:70px;padding-top:5px;">
                </td>
                <td style="padding-left: 120px;">
                    <h1 style="text-align:left;"><a href="<?php echo e(URL::to('/')); ?>" target="_blank" style="color:#ffffff; text-decoration:none;">VOICED</a> </h1>
                </td>
            </tr>
        </table>
    ...
    <div class="card">
        <div class="container">
            ...
            <p>Inquiry Customer Message : <i><?php echo e($details->message); ?></i></p>
...
</html><?php /**PATH C:\laragon\www\voiced-erp-app\resources\views/email-template.blade.php ENDPATH**/ ?>